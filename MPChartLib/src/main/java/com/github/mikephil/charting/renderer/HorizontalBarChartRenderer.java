...
//                if (dataSet.getColor(j / 4) == -1)
//                    mRenderPaint.setColor(dataSet.getColor(j / 4));
//                else {
//                    try {
//                        String label = dataSet.getStackLabels()[j / 100];
//                        for (int i = 0; i < ColorTemplate.getLabelList().size(); i++) {
//                            if (label.equalsIgnoreCase(ColorTemplate.getLabelList().get(i).toString())) {
//                                mRenderPaint.setColor(ColorTemplate.CUSTOM_COLORS[i]);
//
//                            }
//                        }
